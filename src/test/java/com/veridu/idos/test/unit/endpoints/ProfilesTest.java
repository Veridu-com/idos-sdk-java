...
public class ProfilesTest extends AbstractUnit {
    ...
    public void testGetOne() throws ClientProtocolException, IOException, SDKException {
        ...
        profilesMock.setAuthType(IdOSAuthType.USER);
        profilesMock.setBaseURL("https://idos.api.com");
        profilesMock.setDoNotCheckSSLCertificate(false);
        ...
        when(IdOSUtils.generateToken(Mockito.anyString(), Mockito.anyString(), Mockito.anyString()))
                .thenReturn("token");
        assertEquals(json, profilesMock.getOne("username"));
    }
}