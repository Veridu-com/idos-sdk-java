...
public class ProfileGateSamples {
    ...
    public static void main(String[] args) throws SDKException, UnsupportedEncodingException {
         ...
         * creates a new gate. To create or update a gate is necessary to call
         * the method upsert() passing as parameter the userName, the gate's
         * name and the boolean pass value.
         */
         ...
         * to the gates that requires an existing gate.
         */
        if (json.get("status").getAsBoolean() == true) {
            ...
            /**
             * Deletes the gate created/updated passing as parameter the
             * userName and the gate slug.
             */
        ...
        if (json.get("status").getAsBoolean() == true) {
            /**
             * Retrieves information of the gate related to the slug that came
